...
MockData.cloudAccounts = {
  ...
  sub: [
    ...
    { name: 'wanghr-staging', vendor: '阿里云', ramUser: '--', permPackageId: 'mysql-manage', durationType: '长期持有', createTime: '2025/11/15 14:00:00', status: '正常', statusClass: 'success', owner: '王浩然', ownerUsername: 'wanghr', mainAccount: 'infra-main (LTAI****7F2Q)', dept: '基础架构部' },
    { name: 'wanghr-ops', vendor: '阿里云', ramUser: 'ram-wanghr-ops@1234567890.onaliyun.com', permPackageId: 'admin', durationType: '长期持有', createTime: '2025/12/01 10:00:00', status: '已回收', statusClass: 'default', owner: '王浩然', ownerUsername: 'wanghr', mainAccount: 'infra-main (LTAI****7F2Q)', dept: '基础架构部',
    ...
    { name: 'malh-user', vendor: '阿里云', ramUser: 'ram-malh-user@0987654321.onaliyun.com', permPackageId: 'ecs-ops', durationType: '长期持有', createTime: '2026/02/05 14:00:00', status: '已回收', statusClass: 'default', owner: '马丽华', ownerUsername: 'malh', mainAccount: 'biz-prod (LTAI****k9Xm)', dept: '业务研发部',
